...
{
    /// <summary>
    /// Drag source for catalog skill frames. Pointer down previews; drag beyond threshold equips via drop target.
    /// </summary>
    public sealed class LoadoutCatalogSkillDragSource : MonoBehaviour,
        IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        {
            // Threshold + ghost start in OnDrag so short movement still scrolls the catalog.
        }
